...
public class MainActivity extends AppCompatActivity {
    ...
    private static String GET_URL = "https://crocodilian-trade.000webhostapp.com/select_course.php";
    RequestQueue queue;
    ...
    //Which activity is doing this job
    //which url to retrieve information
